...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { followee_user_id: @follow.followee_user_id, follower_user_id: @follow.follower_user_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { followee_user_id: @follow.followee_user_id, follower_user_id: @follow.follower_user_id } }
